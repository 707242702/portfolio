...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    year: 'Ongoing',
    role: 'Researcher',
    description: 'Daily studies, visual experiments, system thinking',
    content: [
      ...
      "These studies often serve as the seed for larger commercial projects, allowing for a space to refine techniques in generative art, 3D rendering, and experimental typography."
    ]
  },
  {
    id: 'work-spatial',
